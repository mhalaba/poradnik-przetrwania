...
},
{
  ...
  sekcje: [
    ...
    { t: "Systemy ostrzegania (skrót)", p: ["Syrena ZACZYNA zagrożenie: dźwięk modulowany, czyli falujący w górę i w dół, przez 3 minuty. Szukasz schronienia.", "Syrena KOŃCZY zagrożenie: dźwięk ciągły, jednostajny, przez 3 minuty. Można wyjść.", "Krótkie, przerywane sygnały to test, zwykle w pierwszy poniedziałek miesiąca. Nic się nie dzieje.", "RCB/RSO: SMS-y alarmowe bez zapisywania się – przychodzą do każdego telefonu w zagrożonym rejonie.", "Radio na baterie: Program 1 Polskiego Radia na falach długich 225 kHz (nadajnik Solec Kujawski, słyszalny w całym kraju). Lokalnie także UKF/FM i DAB+ – swoją częstotliwość UKF sprawdź teraz i zapisz na kartce przy radiu.", "Aplikacje: Alert RCB, Schrony, MeteoAlert, Alarm112, RSO."] },
  ...
  quiz: [
    ...
    { q: "Trzyminutowy dźwięk syreny, ciągły i jednostajny – co oznacza?", o: ["Koniec zagrożenia, alarm odwołany", "Ogłoszenie alarmu, szukaj schronienia", "Test syren"], a: 0, w: "Ciągły kończy, modulowany zaczyna. Alarm ogłasza dźwięk falujący w górę i w dół przez 3 minuty – wtedy się chowasz. Dźwięk równy przez 3 minuty odwołuje alarm – wtedy można wyjść." },
...
},
{
  ...
  sekcje: [
    { t: "Rodzaje sygnałów syren", p: ["Ogłoszenie alarmu (zagrożenie SIĘ ZACZYNA): dźwięk modulowany, falujący w górę i w dół, przez 3 minuty.", "Odwołanie alarmu (zagrożenie SIĘ KOŃCZY): dźwięk ciągły, jednostajny, przez 3 minuty.", "Zapamiętaj różnicę uchem: falujący jak syrena karetki – chowaj się. Równy jak długi gwizd – już po wszystkim.", "Testy syren: zazwyczaj w pierwsze poniedziałki miesiąca – krótkie, przerywane sygnały (np. 1 min zamiast 3), zapowiadane w mediach."] },
