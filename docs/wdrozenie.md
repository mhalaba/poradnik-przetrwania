...
Odwołania do plików w `assets/` mają na końcu `?v=` i numer (obecnie `?v=18`). Po każdej zmianie
...
| `dodatkowa_gra` | podejście do karetki albo hali-drukarki | która gra, czy adres ustawiony |
